...
describe('react jsx', function() {
  ...
  it('should have correct comma in nested children', function() {
    var code = [
      'var x = <div>',
      '  <div><br /></div>',
      '  <Components.vue>{foo}<br />{bar}</Components.vue>',
      '  <br />',
      '</div>;'
    ].join('\n');
    var result = [
      ...
      '  React.createElement(Components.vue, null, foo, ' +
  ...
  it('should avoid wrapping in extra parens if not needed', function() {
    ...
    var result = [
      'var x = React.createElement("div", null, ',
      '  React.createElement(Components.vue, null)',
      ');'
    ].join('\n');
  ...
  it('should allow constructor as prop', function() {
    var code = '<Components.vue constructor="foo" />;';
    var result = 'React.createElement(Components.vue, {constructor: "foo"});';

    expect(transform(code).code).toBe(result);
  });

  it('should allow JS namespacing', function() {
    var code = '<Namespace.Components.vue />;';
    var result = 'React.createElement(Namespace.components.vue, null);';

    expect(transform(code).code).toBe(result);
  });

  it('should allow deeper JS namespacing', function() {
    var code = '<Namespace.DeepNamespace.Components.vue />;';
    var result =
      'React.createElement(Namespace.DeepNamespace.components.vue, null);';
  ...
  it('wraps props in React.__spread for spread attributes', function() {
    var code =
      ...
      '={2 } z />';
    var result =
      'React.createElement(Components.vue, React.__spread({},    x , {y: \n' +
      '2, z: true}))';
  ...
  it('adds appropriate newlines when using spread attribute', function() {
    var code =
      ...
      '  sound="moo" />';
    var result =
      'React.createElement(Components.vue, React.__spread({}, \n' +
      '  this.props, \n' +
      '  {sound: "moo"}))';
